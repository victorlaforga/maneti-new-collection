...
function TemplateAddresses_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var TemplateAddresses_TemplateAddresses = /*#__PURE__*/function () {
  function TemplateAddresses(section) {
    TemplateAddresses_classCallCheck(this, TemplateAddresses);
  ...
  StaticCart_createClass(StaticCart, [{
    ...
    value: function _updateCart(thisTimeoutId) {
      ...
      shopify_asyncview_dist_index_es.load(window.Theme.routes.cart_url, {
        ...
        _this3.totalPrice.innerHTML = data.totalPrice;
      }).fail(function () {
...
function ThemeUtils_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }

function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ThemeUtils_ownKeys(Object(source), true).forEach(function (key) { ThemeUtils_defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ThemeUtils_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }

function ThemeUtils_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var VariantHelper_VariantHelper = /*#__PURE__*/function () {
  ...
  VariantHelper_createClass(VariantHelper, [{
    ...
    value: function _updateTaxLine(variant) {
      if (!variant) return;
      this.options.$priceFields.each(function (i, el) {
        var taxLine = el.querySelector('[data-tax-line]');
        if (!taxLine) return;
    ...
    value: function _updateUnitPrice(variant) {
      ...
      this.options.$priceFields.each(function (i, el) {
        ...
        if (variantFields.unitPrice && variant.unit_price_measurement) {
          variantFields.totalQuantity.innerHTML = "".concat(variant.unit_price_measurement.quantity_value).concat(variant.unit_price_measurement.quantity_unit);
          ...
          if (variant.unit_price_measurement.reference_value === 1) {
            ...
            variantFields.unitPriceMeasure.innerHTML = "".concat(variant.unit_price_measurement.reference_value).concat(variant.unit_price_measurement.reference_unit);
          }
...
var flickity_fade = __webpack_require__(27);
  ...
  function ProductGallery(el, settings) {
    ...
    if (this.navigation) {
      ...
      cjs["onChange"](function (breakpoints) {
        return _this._onBreakpointChange(breakpoints);
      });
    }
...
var Modal = /*#__PURE__*/function () {
  function Modal() {
    ...
    this.modalInnerEl.addEventListener('click', function (e) {
    ...
    this.callbacks = Modal_objectSpread(Modal_objectSpread({}, {
  ...
  Modal_createClass(Modal, [{
    ...
    value: function showModal() {
      ...
      $(this.el).one('trend', function () {
        return _this2.el.classList.add(_this2.selectors.active);
      });
    }
  }]);
...
var ProductDetails_ProductDetails = /*#__PURE__*/function () {
  function ProductDetails(instance) {
      ...
      _this.modal = new Modal({
        ...
        callbacks: {
          onOpen: function onOpen(_ref) {
            ...
            if (_this.productJSON) {
              var variant = _this.variantHelpers ? _this.variantHelpers.getCurrentVariant() : _this.productJSON.variants[0];
              modalHeader.innerHTML = "\n                  <h2 class=\"surface-pick-up-modal__header\">\n                    ".concat(_this.productJSON.title, "\n                  </h2>\n                  ").concat(_this.variantHelpers ? "<span class=\"surface-pick-up-modal__subtitle\">".concat(variant.title, "</span>") : '', "\n                ");
            }
    ...
    this.$el.on('click', '.number-input-nav-item', function (event) {
  ...
  ProductDetails_createClass(ProductDetails, [{
    ...
    value: function setupVariants() {
      ...
      this.variantHelpers.onVariantChange(function (v) {
        return _this2.surfacePickUp.load(v.id);
      });
    ...
    value: function addToCart(e) {
      ...
      if (quantity === '' || quantity === '0') {
        setTimeout(function () {
          ...
          _this3.$el.find('.product-wrap').removeClass('loading added-success').addClass('added-error');
        ...
        Shopify.addItemFromForm(this.productForm, function (cartItem) {
          return setTimeout(function () {
            ...
            _this3.$el.find('.product-wrap').removeClass('loading added-error').addClass('added-success');
    ...
    value: function handleErrors(errors) {
      ...
      if (errorMessage.message === 'Cart Error') {
        setTimeout(function () {
          ...
          _this4.$el.find('.product-wrap').removeClass('loading added-success').addClass('added-error');
...
/***/ })
/******/ ]);
//# sourceMappingURL=site.js.map?1605204342692
